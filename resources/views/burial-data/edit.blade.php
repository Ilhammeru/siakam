            ...
            <form action="{{ route('burial-data.update', $burialData->id) }}" method="POST" id="formBurialData" enctype="multipart/form-data">
                <div class="form-group row mb-5">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="burial_data_id" class="form-control" id="burialId" value="{{ $burialData->burial_data_id }}">
                    </div>
                </div>
                <div class="form-group row mb-5">
                    <div class="col-md-6 col-xl-6">
                        <label for="name" class="col-form-label required">Nama</label>
                        <input type="text" value="{{ $burialData->name }}" name="name" placeholder="Nama Jenazah" class="form-control" id="name">
                    </div>
                    <div class="col-md-6 col-xl-6">
                ...
                <div class="form-group mb-5 row">
                    <div class="col-md-6">
                        ...
                        <select name="regency_of_birth" id="regencyOfBirth" class="form-control">
                            <option value="{{ $burialData->regency_of_birth }}">- Pilih Kota -</option>
                            @foreach ($city as $c)
                ...
                <div class="form-group mb-5 row">
                    <div class="col-md-6">
                        ...
                        <textarea name="address" class="form-control" id="address" cols="1" rows="1">{{ $burialData->address }}</textarea>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="village_id" id="addressVilage" class="form-control">
                            <option value="{{ $burialData->village_id }}">- Pilih Kota -</option>
                            @foreach ($city as $c)
                    ...
                    <div class="col-md-1">
                        ...
                        <input type="number" name="rt" value="{{ $burialData->rt }}" class="form-control" id="addressRt" placeholder="RT">
                    </div>
                    <div class="col-md-1">
                        <label for="addressRw" class="col-form-label required">RW</label>
                        <input type="number" name="rw" value="{{ $burialData->rw }}" class="form-control" id="addressRw" placeholder="RW">
                    </div>
                </div>
                <div class="form-group mb-5 row">
                    <div class="col-md-6">
                ...
                <div class="form-group mb-5 row">
                    <div class="col-md-6">
                        ...
                        <input type="text" value="{{ $burialData->place_of_death }}" name="place_of_death" placeholder="Lokasi Wafat" class="form-control" id="placeOfDeath">
                    </div>
                    <div class="col-md-6">
                        <label for="dateOfDeath" class="col-form-label">Tanggal Wafat</label>
                        <input type="date" value="{{ $burialData->date_of_death }}" name="date_of_death" class="form-control" id="dateOfDeath">
                    </div>
                </div>
                <div class="form-group mb-5 row">
                    <div class="col-md-6">
                        <label for="buriedDate" class="col-form-label">Tanggal Pemakaman</label>
                        <input type="date" value="{{ $burialData->buried_date }}" name="burial_date" class="form-control" id="buriedDate">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-group mb-5 row">
                    ...
                    <div class="{{ Auth::user()->role == 'tpu' ? 'col-md-6' : 'col-md-4' }}">
                        ...
                        <select name="grave_block" onchange="blockOnChange()" value="{{ $burialData->grave_block }}" id="graveBlock" class="form-control">
                ...
                <div class="form-group mb-5 row">
                    <div class="col">
                        ...
                        <textarea name="notes" id="notes" cols="3" rows="3" class="form-control">{{ $burialData->notes }}</textarea>
                    </div>
                </div>
                <div class="form-group mb-5 row">
                    <div class="col-md-6">
...
@push('scripts')
    ...
    <script>
        ...
        if (fileGrave != "") {
            pondGrave.addFile("{{ asset($burialData->grave_photo) }}")
        }
        ...
        if (fileApp != "") {
            pondApplicationLetter.addFile("{{ asset($burialData->application_letter_photo) }}");
        }
        ...
        if (fileKtpCorpse != "") {
            pondKtpCorpse.addFile("{{ asset($burialData->ktp_corpse_photo) }}")
        }
        ...
        if (fileCover != "") {
            pondCoverLetter.addFile("{{ asset($burialData->cover_letter_photo) }}")
        }
        ...
        if (fileRepKtp != "") {
            pondReporterKtp.addFile("{{ asset($burialData->reporter_ktp_photo) }}")
        }
        ...
        if (fileRepKk != "") {
            pondReporterKk.addFile("{{ asset($burialData->reporter_kk_photo) }}")
        }
